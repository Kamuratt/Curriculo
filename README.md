...
Busco uma oportunidade na área de **TI**, principalmente nas áreas de **Ciência de Dados** e **Inteligência Artificial**, onde possa aplicar minha sólida base acadêmica e habilidades técnicas em projetos inovadores e desafiadores. Meu objetivo é contribuir para soluções de impacto, enquanto continuo a expandir meus conhecimentos e habilidades, explorando novas abordagens e tecnologias.
...
**Modelos de Treinamento Empregados:**  
- Decision Tree  
- Naive Bayes  
- K-Neighbors  
- Logistic Regression  
...
**Desafios e Soluções:**  
- **Integração de Funcionalidades Diferenciadas:** Criar classes específicas para jogadores e funcionários, utilizando herança e encapsulamento para separar responsabilidades.  
- **Gerenciamento de Arquivos para Persistência de Dados:** Implementação robusta utilizando `java.io` e `java.nio` para leitura e escrita em arquivos, com validações e tratamento de exceções.  
- **Desenvolvimento de Interfaces com Java Swing:** Criação de layouts consistentes e feedback visual eficiente para o usuário.  
- **Implementação do Sistema de Rolagem de Dados:** Criação de algoritmos de randomização integrados ao sistema.

**Resultados e Aprendizados:**  
- O projeto foi **completo** e **funcional** para o gerenciamento de RPGs.  
- Aprendi profundamente sobre **encapsulamento e POO**.  
...
- **Descrição:** Desenvolvimento completo de um jogo em apenas **5 dias**, utilizando a engine **Godot** e a linguagem **GDScript**.  
- **Contribuições:**  
  - Programação completa do jogo, implementação de mecânicas, animações e lógica de puzzles.  
  - Desenvolvimento de uma **mecânica inovadora de sacrifício** e **sistema de limite de estátuas**.  
  - Implementação de **sistema de chaves e portas**.
...
- **Espanhol: Básico**  
  Conhecimento fundamental, com capacidade de leitura e compreensão simples, além de habilidades de conversação em contextos informais.
